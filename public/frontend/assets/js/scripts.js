(function ($) {
	...
	function setEmptyCart() {
		...
		$('#emptyCart').html('<div class="order-list-img"><img src="/assets/img/bg/empty-cart-small.jpg" alt="Your cart is empty"/></div><div class="order-list-details"> <h4>Your cart is empty</a><br/><small>Start adding items</small></h4> <div class="order-list-price format-price">0.00</div></div>');
		formatPrice();
	}
	...
	function addOptionsItemToCart(id) {
		...
		thumbnailPath = 'assets/img/gallery/grid-items-small/' + id + '.jpg';
