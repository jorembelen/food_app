        ...
        <div class="container" style="transform: none;">
            ...
            <div class="row" style="transform: none;">
                ...
                <div class="theiaStickySidebar" style="padding-top: 0px; padding-bottom: 1px; position: static; transform: none;">
                    <h4>Thank you! Your order was successfully placed.</h4> <br>
                    <h5>Order Details:</h5>
                    <table class="tbl-cart" cellpadding="10" cellspacing="0">
                    ...
                    </table><h3>Customer details:</h3><div>
                            <strong>Name: </strong><span>{{ $order->shipping_fullname }}</span>
                        {{-- </div><div>
                            <strong>Email: </strong><span>cunym@mailinator.com</span> --}}
                        </div><div>
                            <strong>Phone: </strong><span>{{ $order->shipping_phone }}</span>
                        </div><div>
                            <strong>Address: </strong><span>{{ $order->shipping_address }}</span>
                        </div><div>
                            <strong>Message: </strong><span>{{ $order->notes }}</span>
                        </div><div>
                        ...
                        </div><p class="mb-0"><a href="/" class="btn-2">Back to Home</a></p><div class="resize-sensor" style="position: absolute; inset: 0px; overflow: hidden; z-index: -1; visibility: hidden;"><div class="resize-sensor-expand" style="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;"><div style="position: absolute; left: 0px; top: 0px; transition: all 0s ease 0s; width: 1290px; height: 485px;"></div></div><div class="resize-sensor-shrink" style="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;"><div style="position: absolute; left: 0; top: 0; transition: 0s; width: 200%; height: 200%"></div></div></div></div></div>
            </div>
        </div>
    </div>
